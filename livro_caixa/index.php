...
<head>
    ...
    <meta charset="utf-8">
<title id='titulo'>Livro caixa <?php echo $_SESSION['usuario']->nome?></title>
...
<body style="padding:10px" background="imagens/back.png">
...
<h2 style="color:#FFF; margin:5px">Livro Caixa - <?php echo $_SESSION['usuario']->nome?></h2>
</td>
...
<h2 style="color: #FFF"><?php echo mostraMes($mes_hoje)?>/<?php echo $ano_hoje?></h2>
</td>
<td align="right">
...
<td align="right">
<hr size="1" />
    <em style="font-size: small">Livro Caixa - <strong><?php echo $_SESSION['usuario']->nome?></strong> - Versão 1.0 - <a href="index.php?sair=1" class="bnt" style="background-color:#005B5B;"><b style="color: #FFF">Fazer logout</b></a></em>
</td>
</tr>
</table>
</body>
